                  ...
                  <Link href={'https://www.emirates-car.com/blog/' + post.SLUg}>
                    <div className="py-3">
                      <div className="border border-gray-200 p-3 rounded-sm">
                        <div className="w-full bg-red-200 rounded-xl text-white items-center text-center flex justify-center font-bold">
                          <Image
                            alt={post.ALT}
                        ...
                        <h6 className="text-4xl xs:text-lg sm:text-md md:text-lg font-bold font-sans pt-5 text-red-500">
                          {post.TITLE}{' '}
